...
public class DashboardController {
    ...
    public DashboardController(BookingService bookingService, RoomService roomService, FacilityService facilityService) {
    ...
    public String dashboard(Model model, HttpSession session) {
        ...
        // Calendar data - fetch bookings for the next 30 day
